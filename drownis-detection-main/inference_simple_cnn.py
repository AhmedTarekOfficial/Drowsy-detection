# ============================================================
#  inference_simple_cnn.py  —  Video Fatigue Analysis
#  Uses the SimpleFatigueCNN (trained from scratch)
# ============================================================
...
# ============================================================
# IMAGE PREPROCESSING — Simple normalization (matches training)
# ============================================================
...
# ============================================================
# SIMPLE CNN FATIGUE ENGINE
# ============================================================


class SimpleCNNFatigueEngine:
    """
    Fatigue detection engine using the SimpleFatigueCNN
    (trained from scratch, no pretrained backbone).
    """

    def __init__(self, model_path="saved_models/simple_cnn_fatigue.pth"):
    ...
    def load_model(self, model_path):
        ...
        model = build_simple_model(num_classes=2)
        ...
        print(f"✓ Simple CNN model loaded: {model_path}")
